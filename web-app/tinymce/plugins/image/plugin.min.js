        ...
        var generalFormItems = [
            {
                ...
                spacing: 5,
                items: [
                    {name: 'src', type: 'filepicker', filetype: 'image',classes:'img_' + editor.id, label: 'Source', autofocus: true, onchange: updateSize, style: 'width:228px;'},
                    {name: 'insertFile', type: 'button', onclick: openmanager, tooltip: '上传图片', classes: 'btn open', icon: 'browse'}
                ]
            },
            imageListCtrl,
