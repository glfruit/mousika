...
<html>
    <head>
        ...
        <title><g:if
                test="${params.q && params.q?.trim() != ''}">${params.q} -</g:if>Grails Searchable Plugin</title>
    ...
    <body onload="focusQueryInput();">
        <div id="header">
            <h1><a href="http://grails.org/Searchable+Plugin"
                   target="_blank">Grails <span>Searchable</span> Plugin</a>
            </h1>
                ...
                <div class="results">
                    <g:each var="result" in="${searchResult.results}"
                        ...
                        <div class="result">
                            ...
                            <div class="name"><a
                                    href="${link}">${className} #${result.id}</a>
                            </div>
                    ...
                    <div class="paging">
                        <g:if test="${haveResults}">
                            ...
                            <g:if test="${totalPages == 1}"><span
                                    class="currentStep">1</span></g:if>
                            <g:else><g:paginate controller="searchable"
                                                action="index"
                                                params="[q: params.q]"
