	...
	<body>
		...
		<div id="show-page" class="content scaffold-show" role="main">
			...
			<ol class="property-list page">
				...
				<li class="fieldcontain">
					<span id="sequence-label" class="property-label"><g:message code="page.sequence.label" default="Sequence" /></span>
					
						<span class="property-value" aria-labelledby="sequence-label"><g:fieldValue bean="${pageInstance}" field="sequence"/></span>
