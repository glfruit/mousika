...
<html>
	...
	<body>
		<a href="#edit-fileResource" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-fileResource" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${fileResourceInstance?.version}" />
				<fieldset class="form">
